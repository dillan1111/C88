...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchbook(bookName, "AIzaSyAKFG92gio3KVqOgb9EMED2eBwj7LkK-_Y")
...
componentDidMount(){
  ...
  //var books = BookSearch.searchbook("A Tale of Two Cities","AIzaSyAKFG92gio3KVqOgb9EMED2eBwj7LkK-_Y")
